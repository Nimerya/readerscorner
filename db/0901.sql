...
--
-- Host: localhost:3306
-- Generation Time: Jan 09, 2017 at 05:08 PM
...
('price', 'placeholder="123.45"', 'pattern="^\\d+\\.{0,1}\\d{0,2}$" min="0.01" step="0.01"'),
...
(5, 'Error: Login &nbsp&nbsp (╯°□°）╯︵ ┻━┻', '', 'You are here because the Email/Password you inserted is wrong, please go back and try again.', 0, 1, 'error_login'),
(7, 'Error: Access Denied &nbsp&nbsp ಠ_ಠ', '', 'This happens when you try to access an area that is not available for you or your user group.\r\n', 0, 1, 'error_permission'),
...
(16, 'Error: 404 &nbsp&nbsp ¯\\_(ツ)_/¯', '', 'The page you are trying to access doesn\'t exists.', 0, 1, 'error_404'),
